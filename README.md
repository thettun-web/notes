...
1.  **Clone the repository:**
    ...
    ```
2.  **Open the app:**
    Navigate to the folder and double-click `index.html`. That's it!

### Option 2: Deployment
This app is "Netlify Ready".
1.  Drag and drop the project folder into [Netlify](https://www.netlify.com/).
...
<a href="https://buymeacoffee.com/thetnaingtun" target="_blank">
...
<p align="center">
  Made with ❤️ by <strong>Thet Naing Tun</strong>
</p>
